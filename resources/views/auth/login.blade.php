...
@section('content')
    <div class="mx-auto h-full flex justify-center items-center bg-gray-300">
        <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6">
            <h1 class="text-white text-3xl">Добро пожаловать</h1>
            <h2 class="text-blue-300">Введите логин и пароль</h2>
            ...
            <form method="POST" action="{{ route('login') }}" class="pt-4">
                ...
                <div class="relative pt-3">
                    <label for="password"
                           class="uppercase text-blue-500 text-xs font-bold absolute pl-3 pt-2">Пароль</label>
                ...
                <div class="pt-2">
                    ...
                    <label class="text-white" for="remember">Запомнить меня</label>
                </div>

                <div class="pt-8">
                    <button type="submit"
                            class="bg-gray-400 uppercase rounded text-blue-800 font-bold py-2 px-3 w-full">
                        Войти
                    </button>
                </div>
